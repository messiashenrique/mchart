...
- Repositório / Repository: `https://github.com/messiashenrique/mchart`
- Módulo / Module: `github.com/messiashenrique/mchart`
...
func main() {
  c := mchart.NewBarChart("Resumo", []mchart.BarItem{
    {Label: "Parte A", Value: 70},
    {Label: "Parte B", Value: 45},
  })
...
#### 1) ColumnChart (Gráfico de Colunas)
...
// chart.ValueMode = mchart.ValueModePercent      // valores percentuais + paleta padrão
// chart.ValueMode = mchart.ValueModePercentColor // valores percentuais + cores por faixa
```
...
- Gráficos com suporte a tema escuro possuem `Theme` (`...ThemeDark`).
- Quando uma cor não é informada explicitamente, a biblioteca usa a paleta padrão (`colors.go`).
...
Arquivos gerados em: `examples/all-charts/out/`.
